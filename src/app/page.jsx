...
//     setRedactedText(text.replace(/\S/g, '█'))
//   }, [text])

//   return { text, setText, redactedText, redact }
// }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <button
                // onClick={redact}
                className="w-full bg-white text-black font-bold py-2 px-4 rounded-lg hover:bg-gray-200 transition duration-200"
              >
                Redact Text
              </button>
              <div className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg relative">
              <p className="text-white font-mono break-all">'Redacted text will appear here...'</p>
